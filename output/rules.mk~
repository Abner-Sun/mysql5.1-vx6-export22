...
CCP := /home/sfh/vx68_mysql/WindRiver68/gnu/4.1.2-vxworks-6.8/x86-linux2/bin/c++pentium
LD := /home/sfh/vx68_mysql/WindRiver68/gnu/4.1.2-vxworks-6.8/x86-linux2/bin/ldpentium
AR := /home/sfh/vx68_mysql/WindRiver68/gnu/4.1.2-vxworks-6.8/x86-linux2/bin/arpentium
RANLIB := /home/sfh/vx68_mysql/WindRiver68/gnu/4.1.2-vxworks-6.8/x86-linux2/bin/ranlibpentium
STRIP := $(CROSS)strip
...
CFLAGS := -mtune=pentium4 -march=pentium4 -mrtp -fno-strict-aliasing -D_C99 -D_HAS_C9X  -D_VX_CPU=_VX_PENTIUM4 -D_VX_TOOL_FAMILY=gnu -D_VX_TOOL=gnu -I$(WIND_BASE)/target/usr/h -I$(WIND_BASE)/target/usr/h/wrn/coreip -I$(WIND_COMPONENTS)/$COMP_WINDML/h -I$(WIND_COMPONENTS)/$(COMP_WINDML)/src/include/$(WIND_PLATFORM) -I$(WIND_HOME)/../vx68_miss/include -D__WORDSIZE=32 -D_MACH_I32=int
